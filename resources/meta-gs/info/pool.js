...
export const poolDetail = [{
  ...
  char4: ['瑶瑶', '辛焱', '凝光'],
  weapon5: ['和璞鸢', '神乐之真意'],
  weapon4: ['千岩古剑', '匣里龙吟', '西风长枪', '流浪乐章', '绝弦']
}, {
  version: '4.5',
  half: '上半',
  ...
  char4: ['烟绯', '香菱', '雷泽'],
  weapon5: ['柔灯挽歌', '若水'],
  weapon4: ['玛海菈的水色', '流浪的晚星', '笛剑', '西风长枪', '西风猎弓']
}, {
  version: '5.0',
  half: '上半',
  ...
  char4: ['托马', '九条裟罗', '夏沃蕾'],
  weapon5: ['山王长牙', '薙草之稻光'],
  weapon4: ['祭礼剑', '雨裁', '西风长枪', '流浪乐章', '祭礼弓']
}, {
  version: '5.1',
  half: '上半',
  from: '2024-10-09 06:00:00',
  to: '2024-10-29 17:59:59',
  char5: ['希诺宁', '千织'],
  char4: ['多莉', '坎蒂丝', '柯莱'],
  weapon5: ['岩峰巡歌', '有乐御簾切'],
  weapon4: ['弥坚骨', '镇山之钉', '祭礼大剑', '西风秘典', '弓藏']
}, {
  version: '5.1',
  half: '下半',
  from: '2024-10-29 18:00:00',
  to: '2024-11-19 14:59:59',
  char5: ['纳西妲', '胡桃'],
  char4: ['赛索斯', '行秋', '久岐忍'],
  weapon5: ['千夜浮梦', '护摩之杖'],
  weapon4: ['硕果钩', '匣里龙吟', '匣里灭辰', '昭心', '西风猎弓']
}, {
  version: '5.2',
  half: '上半',
  from: '2024-11-20 06:00:00',
  to: '2024-12-10 17:59:59',
  char5: ['恰斯卡', '林尼'],
  char4: ['欧洛伦', '砂糖', '芭芭拉'],
  weapon5: ['星鹫赤羽', '最初的大魔术'],
  weapon4: ['乘浪的回旋', '缀花之翎', '笛剑', '钟剑', '西风长枪']
}, {
  version: '5.2',
  half: '下半',
  ...
  char4: ['鹿野院平藏', '菲谢尔', '瑶瑶'],
  weapon5: ['万世流涌大典', '贯虹之槊'],
  weapon4: ['幽夜华尔兹', '西风剑', '西风大剑', '匣里灭辰', '祭礼残章']
}, {
  version: '5.3',
  half: '上半',
  ...
  char4: ['蓝砚', '夏沃蕾', '罗莎莉亚'],
  weapon5: ['赤月之形', '赦罪'],
  weapon4: ['千岩长枪', '匣里龙吟', '雨裁', '流浪乐章', '祭礼弓']
}, {
  version: '5.4',
  half: '上半',
  from: '2025-02-12 06:00:00',
  to: '2025-03-04 17:59:59',
  char5: ['梦见月瑞希', '希格雯'],
  char4: ['五郎', '早柚', '香菱'],
  weapon5: ['寝正月初晴', '白雨心弦'],
  weapon4: ['恶王丸', '断浪长鳍', '曚云之月', '笛剑', '昭心']
}, {
  version: '5.4',
  half: '下半',
  ...
  char4: ['夏洛蒂', '重云', '米卡'],
  weapon5: ['静水流涌之辉', '金流监督'],
  weapon4: ['西风剑', '祭礼大剑', '匣里灭辰', '祭礼残章', '弓藏']
}, {
  version: '5.5',
  half: '上半',
  from: '2025-03-26 06:00:00',
  to: '2025-04-15 17:59:59',
  char5: ['瓦雷莎', '闲云'],
  char4: ['伊安珊', '夏沃蕾', '嘉明'],
  weapon5: ['溢彩心念', '鹤鸣余音'],
  weapon4: ['弥坚骨', '硕果钩', '镇山之钉', '乘浪的回旋', '缀花之翎']
}, {
  version: '5.5',
  half: '下半',
  from: '2025-04-15 18:00:00',
  to: '2025-05-06 14:59:59',
  char5: ['希诺宁', '温迪'],
  char4: ['珐露珊', '北斗', '烟绯'],
  weapon5: ['岩峰巡歌', '终末嗟叹之诗'],
  weapon4: ['祭礼剑', '钟剑', '西风长枪', '西风秘典', '西风猎弓']
}, {
  version: '5.6',
  half: '上半',
  from: '2025-05-07 06:00:00',
  to: '2025-05-27 17:59:59',
  char5: ['爱可菲', '娜维娅'],
  char4: ['伊法', '欧洛伦', '莱依拉'],
  weapon5: ['香韵奏者', '裁断'],
  weapon4: ['船坞长剑', '便携动力锯', '勘探钻机', '测距规', '流浪乐章']
}, {
  version: '5.6',
  half: '下半',
  ...
  char4: ['琳妮特', '九条裟罗', '托马'],
  weapon5: ['山王长牙', '薙草之稻光'],
  weapon4: ['匣里龙吟', '西风大剑', '匣里灭辰', '昭心', '绝弦']
}, {
  version: '5.7',
  half: '上半',
  from: '2025-06-18 06:00:00',
  to: '2025-07-08 17:59:59',
  char5: ['丝柯克', '申鹤'],
  char4: ['塔利雅', '坎蒂丝', '迪奥娜'],
  weapon5: ['苍耀', '息灾'],
  weapon4: ['西福斯的月光', '玛海菈的水色', '流浪的晚星', '西风长枪', '祭礼弓']
}, {
  version: '5.7',
  half: '下半',
  from: '2025-07-08 18:00:00',
  to: '2025-07-29 14:59:59',
  char5: ['玛薇卡', '艾梅莉埃'],
  char4: ['香菱', '瑶瑶', '伊安珊'],
  weapon5: ['焚曜千阳', '柔灯挽歌'],
  weapon4: ['笛剑', '雨裁', '匣里灭辰', '祭礼残章', '弓藏']
}, {
  version: '5.8',
  half: '上半',
  from: '2025-07-30 06:00:00',
  to: '2025-08-19 17:59:59',
  char5: ['伊涅芙', '茜特菈莉'],
  char4: ['赛索斯', '菲谢尔', '行秋'],
  weapon5: ['支离轮光', '祭星者之望'],
  weapon4: ['弥坚骨', '镇山之钉', '祭礼大剑', '西风秘典', '西风猎弓']
}, {
  version: '5.8',
  half: '下半',
  from: '2025-08-19 18:00:00',
  to: '2025-09-09 14:59:59',
  char5: ['玛拉妮', '恰斯卡'],
  char4: ['伊法', '欧洛伦', '班尼特'],
  weapon5: ['冲浪时光', '星鹫赤羽'],
  weapon4: ['硕果钩', '乘浪的回旋', '缀花之翎', '西风剑', '西风长枪']
}, {
  version: '6.0',
  half: '上半',
  ...
  char4: ["爱诺", "砂糖", "多莉"],
  weapon5: ["血染荒城", "若水"],
  weapon4: ["匣里龙吟", "西风大剑", "西风长枪", "西风秘典", "祭礼弓"]
}, {
  version: "6.1",
  half: "上半",
  from: "2025-10-22 06:00:00",
  to: "2025-11-11 17:59:59",
  char5: ["奈芙尔", "芙宁娜"],
  char4: ["行秋", "柯莱", "瑶瑶"],
  weapon5: ["真语秘匣", "静水流涌之辉"],
  weapon4: ["织月者的曙色", "圣祭者的辉杖", "霜辰", "钟剑", "西风猎弓"]
}, {
  version: "6.1",
  half: "下半",
  from: "2025-11-11 18:00:00",
  to: "2025-12-02 14:59:59",
  char5: ["阿蕾奇诺", "钟离"],
  char4: ["蓝砚", "罗莎莉亚", "云堇"],
  weapon5: ["赤月之形", "贯虹之槊"],
  weapon4: ["船坞长剑", "便携动力锯", "测距规", "匣里灭辰", "祭礼残章"]
}, {
  version: "6.2",
  half: "上半",
  from: "2025-12-03 06:00:00",
  to: "2025-12-23 17:59:59",
  char5: ["杜林", "温迪"],
  char4: ["雅珂达", "班尼特", "珐露珊"],
  weapon5: ["黑蚀", "黎明破晓之史"],
  weapon4: ["暗巷闪光", "勘探钻机", "暗巷的酒与诗", "雨裁", "绝弦"]
}, {
  version: "6.2",
  half: "下半",
  from: "2025-12-23 18:00:00",
  to: "2026-01-13 14:59:59",
  char5: ["瓦雷莎", "希诺宁"],
  char4: ["伊安珊", "夏沃蕾", "嘉明"],
  weapon5: ["溢彩心念", "岩峰巡歌"],
  weapon4: ["硕果钩", "暗巷猎手", "西风剑", "西风长枪", "流浪乐章"]
}
]
...
export const mixPoolDetail = [{
  ...
  weapon4: ['暗巷闪光', '暗巷的酒与诗', '幽夜华尔兹', '暗巷猎手']
}, {
  version: '5.3',
  half: '下半',
  from: '2025-01-21 18:00:00',
  to: '2025-02-11 14:59:59',
  char5: ['白术', '申鹤', '甘雨', '达达利亚', '魈'],
  weapon5: ['磐岩结绿', '斫峰之刃', '无工之剑', '息灾', '碧落之珑', '尘世之锁', '冬极白星'],
  weapon4: ['千岩古剑', '千岩长枪']
}, {
  version: '5.6',
  half: '下半',
  from: '2025-05-27 18:00:00',
  to: '2025-06-17 14:59:59',
  char5: ['神里绫华', '神里绫人', '宵宫', '千织', '八重神子', '荒泷一斗', '珊瑚宫心海', '枫原万叶'],
  char4: ['久岐忍', '绮良良', '鹿野院平藏', '九条裟罗', '五郎', '早柚', '托马'],
  weapon5: ['雾切之回光', '波乱月白经津', '飞雷之弦振', '有乐御簾切', '神乐之真意', '赤角石溃杵', '不灭月华', '苍古自由之誓'],
  weapon4: ['匣里龙吟', '祭礼剑', '笛剑', '西风剑', '恶王丸', '雨裁', '祭礼大剑', '钟剑', '西风大剑', '断浪长鳍', '西风长枪', '匣里灭辰', '昭心', '祭礼残章', '流浪乐章', '西风秘典', '曚云之月', '弓藏', '祭礼弓', '绝弦', '西风猎弓']
}, {
  version: '6.0',
  half: '上半',
  from: '2025-09-10 06:00:00',
  to: '2025-09-30 17:59:59',
  char5: ['迪希雅', '艾尔海森', '流浪者', '赛诺', '妮露', '提纳里'],
  char4: ['赛索斯', '卡维', '珐露珊', '莱依拉', '坎蒂丝', '多莉', '柯莱'],
  weapon5: ['裁叶萃光', '圣显之钥', '苇海信标', '赤沙之杖', '图莱杜拉的回忆', '猎人之径'],
  weapon4: ['西福斯的月光', '匣里龙吟', '祭礼剑', '笛剑', '西风剑', '玛海菈的水色', '雨裁', '祭礼大剑', '钟剑', '西风大剑', '西风长枪', '匣里灭辰', '流浪的晚星', '昭心', '祭礼残章', '流浪乐章', '西风秘典', '曚云之月', '弓藏', '祭礼弓', '绝弦', '西风猎弓']
}]
